...
class Profile:
    ...
    @staticmethod
    def _check_remote_config(config: Dict):
    ...
    def _get_remote_config(
        ...
        in the profile and cached_config_ok = True, then it's returned as is,
        ...
        if self.remote_config_fetched or (
            cached_config_ok and self._cached_remote_config
        ):
            return self._cached_remote_config
        ...
        if remote_config != self._cached_remote_config:
