...
Apio CLI is an easy to install and use command-line tool for FPGA design. For a quick start, visit the [Getting started with Apio](https://fpgawars.github.io/apio/docs/quick-start) guide.
