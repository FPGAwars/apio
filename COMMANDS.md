...
Usage: apio api info [OPTIONS]
  ...
  The command 'apio api info' exports apio information as a JSON
  document.
  ...
  Examples:
    ...
    apio api info  -o apio.json  # Write to a file

  Currently, the JSON document includes a list of supported boards and
  various
...
Usage: apio clean [OPTIONS]
  ...
  commands. By default it cleans up only for the default env but can be
  ...
  Example:
    ...
    apio clean --all           # Clean all envs

Options:
  -a, --all               Clean all envs.
  -e, --env name          Select an env to clean.
  -p, --project-dir path  Set the root directory for the project.
  -h, --help              Show this message and exit.
