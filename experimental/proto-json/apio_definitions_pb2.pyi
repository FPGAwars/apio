...
import apio_common_pb2 as _apio_common_pb2
...
class Definitions(_message.Message):
    ...
    fpgas: _containers.MessageMap[str, FpgaDefinition]
    programmers: _containers.MessageMap[str, ProgrammerDefinition]
    def __init__(self, boards: _Optional[_Mapping[str, BoardDefinition]] = ..., fpgas: _Optional[_Mapping[str, FpgaDefinition]] = ..., programmers: _Optional[_Mapping[str, ProgrammerDefinition]] = ...) -> None: ...
