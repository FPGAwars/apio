{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "0d6c0172-aa96-4b29-bcd1-0211a391bfa5",
          "type": "basic.input",
          "data": {
            "name": "btn",
            "range": "[1:0]",
        ...
        {
          "id": "5dc89918-e7ab-4373-86da-97cad88896d2",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "range": "[1:0]",
        ...
        {
          "id": "daea6822-8a9e-4493-a6eb-029da8a1020b",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "range": "[1:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# BlackIce: LEDs and Buttons test\n\nTesting the LEDs and buttons",
            "readonly": true
          },
          "position": {
            "x": 80,
        ...
        {
          "id": "899b1216-123b-4f1c-ba05-67a75c38d1e5",
        ...
        {
          "id": "dcbcc7b9-ca9f-4e69-9608-5cc58759f4f8",
          "type": "basic.info",
          "data": {
            "info": "Testing buttons SW1 and SW2 on LEDs 1 and 2 (Positive logics) and LEDs 3 y 4 (Negative logics)",
            "readonly": true
          },
          "position": {
            "x": 64,
      ...
      "wires": [
        {
          "source": {
            "block": "0d6c0172-aa96-4b29-bcd1-0211a391bfa5",
            "port": "out"
          },
          "target": {
            "block": "5dc89918-e7ab-4373-86da-97cad88896d2",
            "port": "in"
          },
          "vertices": [],
          "size": 2
        ...
        {
          "source": {
            "block": "899b1216-123b-4f1c-ba05-67a75c38d1e5",
            "port": "32f70bc0-92bf-4ed2-8481-f8539240c902"
          },
          "target": {
            "block": "daea6822-8a9e-4493-a6eb-029da8a1020b",
            "port": "in"
          },
          "vertices": [],
          "size": 2
