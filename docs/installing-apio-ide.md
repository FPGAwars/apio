...
| [4] Apio terminal        | Appears when an Apio CORE command is executed or when **TOOLS → misc → apio shell** is selected. | Shows the output of Apio CORE commands and provides the interactive Apio shell. |
